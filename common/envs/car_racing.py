...
class CarRacingRandomized(gym.Env, EzPickle):
    metadata = {
    ...
    def __init__(self, verbose=1, **kwargs):
        ...
        self.engine_power = 100000000 * 0.02 * 0.02
        self.wheel_moment_of_inertia = 4000 * 0.02 * 0.02
        self.friction_limit = 1000000 * 0.02 * 0.02
        
    def _update_randomized_params(self):
        self.engine_power = self.dimensions[0].current_value
        self.wheel_moment_of_inertia = self.dimensions[1].current_value
        self.friction_limit = self.dimensions[2].current_value
    ...
    def reset(self):
        ...
        self.car = Car(self, self.world, *self.track[0][1:4])
