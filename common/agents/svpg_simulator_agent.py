...
class SVPGSimulatorAgent(object):
    ...
    def __init__(self,
        ...
        self.log_distances = (reference_env_id.find('Lunar') == -1 and reference_env_id.find('Car') == -1)
        ...
        if reference_env_id.find('Cart') != -1:
            self.hard_env = make_vec_envs('CartPoleHard-v0', seed, nagents)
        elif reference_env_id.find('Racing') != -1:
